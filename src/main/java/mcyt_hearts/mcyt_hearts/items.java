...
public class items {
    ...
    public static final Item PRESTON_HEART = new Item(new FabricItemSettings().group(creativeModGroup));
    public static final Item MRBEAST_HEART = new Item(new FabricItemSettings().group(creativeModGroup));
    public static final Item CRAFTEE_HEART = new Item(new FabricItemSettings().group(creativeModGroup));
    public static final Item WISP_HEART = new Item(new FabricItemSettings().group(creativeModGroup));
    public static final Item KARL_HEART = new Item(new FabricItemSettings().group(creativeModGroup));
